...
test('correct task should be added to correct array', () => {
    ...
    const action = addTask.fulfilled({task}, 'requestId', {title: task.title, todolistId:task.id} );
...
test('status of specified task should be changed', () => {
    ...
    const action = updateTask.fulfilled(model,'requestId', model);
...
test('title of specified task should be changed', () => {
    let model  = {taskId:"2",model:{title: "yogurt"},todolistId:"todolistId2"};
...
test('empty arrays should be added when we set todolists', () => {
    ...
    const action = fetchTodolists.fulfilled({todolists},'requestId')
